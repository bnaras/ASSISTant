...
```{r}
result1 <- defuse3$explore(numberOfSimulations = 5000,
...
```{r}
result2 <- defuse3$explore(numberOfSimulations = 5000,
...
```{r}
designParameters <- list(
    nul0 = list(prevalence = rep(1/2, 2),
                ctlDist = null.uniform,
                trtDist = cbind(null.uniform,
                                null.uniform)),
    alt1 = list(prevalence = rep(1/2, 2), 
                ctlDist = null.uniform,
                trtDist = cbind(top.loaded,
                                null.uniform)),
    alt2 = list(prevalence = rep(1/2, 2), 
                ctlDist = null.uniform,
                trtDist = cbind(null.uniform,
                                top.loaded))
)
...
```{r}
result <- discDefuse3$explore(numberOfSimulations = 5000,
                              showProgress = FALSE,
                              rngSeed = 3783)
...
```{r}
result1 <- discDefuse3$explore(numberOfSimulations = 5000,
                               trueParameters = designParameters$alt1,
                               showProgress = FALSE,
                               rngSeed = 28912)
...
```{r}
result2 <- discDefuse3$explore(numberOfSimulations = 5000,
                               trueParameters = designParameters$alt2,
                               showProgress = FALSE,
                               rngSeed = 931)
