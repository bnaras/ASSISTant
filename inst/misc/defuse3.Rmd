...
```{r}
defuse3 <- DEFUSE3Design$new(trialParameters = trialParameters,
                             designParameters = designParameters$alt1, showProgress = FALSE)
print(defuse3)
```
...
```{r}
defuse3 <- DEFUSE3Design$new(trialParameters = trialParameters,
                             designParameters = designParameters$alt2, showProgress = FALSE)
print(defuse3)
```
...
```{r}
defuse3 <- DEFUSE3Design$new(trialParameters = trialParameters,
                             designParameters = designParameters$alt3, showProgress = FALSE)
print(defuse3)
```
...
```{r}
defuse3 <- DEFUSE3Design$new(trialParameters = trialParameters,
                             designParameters = designParameters$alt4, showProgress = FALSE)
print(defuse3)
```
...
```{r}
defuse3 <- DEFUSE3Design$new(trialParameters = trialParameters,
                             designParameters = designParameters$alt5, showProgress = FALSE)
print(defuse3)
```
...
```{r}
defuse3 <- DEFUSE3Design$new(trialParameters = trialParameters,
                             designParameters = designParameters$alt6, showProgress = FALSE)
print(defuse3)
```
